...
type AlertEvent struct {
	...
	Status      string  `gorm:"type:varchar(20);not null;default:'firing';comment:状态(firing/resolved/acknowledged);index:idx_alert_events_status_notify,priority:1" json:"status"`
	...
	NotifySent    bool   `gorm:"not null;default:false;comment:是否已发送通知;index:idx_alert_events_status_notify,priority:2" json:"notify_sent"`
	NotifySentAt  *time.Time `gorm:"comment:通知发送时间;index:idx_alert_events_status_notify,priority:3" json:"notify_sent_at,omitempty"`
}
